...
public class ChapterFourQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter_four_quiz);
...
// when answer is correct, number of correct answers at the top right increases
        if (answerString.equalsIgnoreCase(questionModelArraylist.get(currentPosition).getAnswers())) {
            ...
            new SweetAlertDialog(ChapterFourQuiz.this, SweetAlertDialog.SUCCESS_TYPE)
                    .setTitleText("")
...
//feedback provided in opo-up upon answering question incorrectly
            new SweetAlertDialog(ChapterFourQuiz.this, SweetAlertDialog.ERROR_TYPE)
