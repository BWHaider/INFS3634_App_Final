...
public class ChapterOneYoutubeActivity extends YouTubeBaseActivity
implements YouTubePlayer.OnInitializedListener {
    //Tags, API keys and youtube video urls for each chapter
    private static final String TAG = "ChapterOneYoutubeActivi";
        static final String GOOGLE_API_KEY = "AIzaSyBRuf_ZX_Q_wTodzDVaYDNfWdw-xsUCbiU";
        static final String YOUTUBE_VIDEO_ID = "5t0Y13AkWgc";
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ConstraintLayout layout = (ConstraintLayout) getLayoutInflater().inflate(R.layout.activity_chapter_one_youtube, null);
            setContentView(layout);
//View to display Youtube player
            YouTubePlayerView playerView = new YouTubePlayerView(this);
            layout.addView(playerView);
            playerView.initialize(GOOGLE_API_KEY, this);

        }
//Toast for successful initalisation
        @Override
...
//Toast for unsuccessful initalisation
        @Override
