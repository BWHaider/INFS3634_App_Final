...
public class ChapterSevenYoutubeActivity extends YouTubeBaseActivity
implements YouTubePlayer.OnInitializedListener {
    private static final String TAG = "ChapterSevenYoutubeActi";
        static final String GOOGLE_API_KEY = "AIzaSyBRuf_ZX_Q_wTodzDVaYDNfWdw-xsUCbiU";
        static final String YOUTUBE_VIDEO_ID = "ccOzcjHQVos";
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ConstraintLayout layout = (ConstraintLayout) getLayoutInflater().inflate(R.layout.activity_chapter_seven_youtube, null);
