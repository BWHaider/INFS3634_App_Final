...
public class ChapterThreeQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter_three_quiz);
...
// when answer is correct, number of correct answers at the top right increases
        if (answerString.equalsIgnoreCase(questionModelArraylist.get(currentPosition).getAnswers())) {
            ...
            new SweetAlertDialog(ChapterThreeQuiz.this, SweetAlertDialog.SUCCESS_TYPE)
                    .setTitleText("")
...
//feedback provided in opo-up upon answering question incorrectly
            new SweetAlertDialog(ChapterThreeQuiz.this, SweetAlertDialog.ERROR_TYPE)
